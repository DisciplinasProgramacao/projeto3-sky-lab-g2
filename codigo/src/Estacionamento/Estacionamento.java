...
public class Estacionamento implements IDataToText {
     ...
     */
    public void addVeiculo(Veiculo veiculo, String idCli) throws VeiculoJaExistenteException {
     ...
     */
    public void estacionar(String placa, LocalDateTime entrada) throws VagaOcupadaException {
     ...
     */
    public double sair(String placa, LocalDateTime saida) throws UsoDeVagaFinalizadoException {
        Veiculo veiculo = encontrarVeiculo(placa);
        if (veiculo != null) {
